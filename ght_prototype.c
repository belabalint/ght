...
void disconnect_from_mohm(int address)
{
    if (relay_address < 75)
    {
        TI_595_state_vector[relay_address]='1';     // do not drive spst, disconnect from 1MOhm
    }
    else
    {
        TI_595_state_vector[relay_address+1]='1';   // do not drive spst, disconnect from 1MOhm
    }
    update_595_state();
}
